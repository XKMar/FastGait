...
class ProgressMeter(object):
    ...
    def display(self, batch):
        entries = [
            self.prefix + self.batch_fmtstr.format(batch)
        ]
...
class Meters(object):
    """ Store and print the parameters (e.g, loss value, mean dist, images, etc)
     generated by the network training process to the console and tensorboard.

     Args:
        meter_format (dict[dict[str]]): 
        num_batches (int): the total iteration numbers 
     """
